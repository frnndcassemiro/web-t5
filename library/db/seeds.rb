...
Zipcode.create([
  {info: 'Rua dos Bobos, 000', city: 'Curitiba' , state: 'Parana'},
  {info: 'Rua dos Bobos, 001', city: 'Curitiba' , state: 'Parana'},
  {info: 'Rua dos Bobos, 010', city: 'Curitiba' , state: 'Parana'},
  {info: 'Rua dos Bobos, 011', city: 'Curitiba' , state: 'Parana'},
  {info: 'Rua dos Bobos, 100', city: 'Curitiba' , state: 'Parana'},
  {info: 'Rua dos Bobos, 101', city: 'Curitiba' , state: 'Parana'}
...
User.create([
  {name: 'Fulaninho Um ', email: 'fulaninho@um.com' , zipcode_id: '1'},
  {name: 'Fulaninho Dois ', email: 'fulaninho@dois.com' , zipcode_id: '2'},
  {name: 'Fulaninho Tres ', email: 'fulaninho@tres.com' , zipcode_id: '3'},
  {name: 'Fulaninho Quatro ', email: 'fulaninho@quatro.com' , zipcode_id: '4'},
  {name: 'Fulaninho Cinco ', email: 'fulaninho@cinco.com' , zipcode_id: '5'}
])
